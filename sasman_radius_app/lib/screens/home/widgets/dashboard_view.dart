...
class DashboardView extends StatefulWidget {
  ...
  final ValueChanged<String> onNavigateToUsers;
              ...
              Wrap(
                ...
                children: [
                  _StatCard(
                    ...
                    onTap: () => widget.onNavigateToUsers('all'),
                  ),
                  _StatCard(
                    title: loc.activeUsers,
                    value: data.activeUsers.toString(),
                    icon: Icons.verified_user_rounded,
                    gradient: AppTheme.gradientGreen,
                    onTap: () => widget.onNavigateToUsers('active'),
                  ),
                  _StatCard(
                    title: loc.onlineUsers,
                    value: data.onlineUsers.toString(),
                    icon: Icons.wifi_rounded,
                    gradient: AppTheme.gradientCyan,
                    onTap: () => widget.onNavigateToUsers('online'),
                  ),
                  _StatCard(
                    title: loc.expiredUsers,
                    value: data.expiredUsers.toString(),
                    icon: Icons.warning_rounded,
                    gradient: AppTheme.gradientRed,
                    onTap: () => widget.onNavigateToUsers('expired'),
                  ),
                  _StatCard(
                    title: loc.aboutToExpire,
                    value: data.aboutToExpire.toString(),
                    icon: Icons.event_note_rounded,
                    gradient: AppTheme.gradientAmber,
                    onTap: () => widget.onNavigateToUsers('about-to-expire'),
                  ),
                  _StatCard(
                    title: loc.balance,
                    value: '${data.balance} ${loc.currency}',
